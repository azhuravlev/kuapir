  ...
  class ReviewsResponseReviews
    ...
    def self.openapi_types
      {
        ...
        'review_type':          :String,
        'review_data':          :String,
        'user_positive_rating': :String,
        'user_negative_rating': :String,
        'review_autor':         :String,
        'review_title':         :String,
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              "The input argument (attributes) must be a hash in `Kuapir::ReviewsResponseReviews` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Kuapir::ReviewsResponseReviews`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
