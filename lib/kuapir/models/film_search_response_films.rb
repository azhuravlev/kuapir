...
module Kuapir
  class FilmSearchResponseFilms
    attr_accessor :film_id, :name_ru, :name_en, :type, :year, :description, :film_length, :countries, :genres,
                  :rating, :rating_vote_count, :poster_url, :poster_url_preview
    ...
    def type=(type)
      validator = EnumAttributeValidator.new("String", %w[FILM VIDEO TV_SERIES MINI_SERIES TV_SHOW UNKNOWN])
