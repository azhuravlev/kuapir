...
module Kuapir
  class ReviewDetailsResponse
    ...
    def list_invalid_properties
      ...
      if @user_positive_rating.nil?
        invalid_properties.push('invalid value for "user_positive_rating", user_positive_rating cannot be nil.')
      end

      if @user_negative_rating.nil?
        invalid_properties.push('invalid value for "user_negative_rating", user_negative_rating cannot be nil.')
      end
      ...
      if @review_description.nil?
        invalid_properties.push('invalid value for "review_description", review_description cannot be nil.')
      end
    ...
    def review_type=(review_type)
      ...
      unless validator.valid?(review_type)
        raise ArgumentError,
              "invalid value for \"review_type\", must be one of #{validator.allowable_values}."
      end
