...
module Kuapir
  class PersonResponseSpouses
    attr_accessor :person_id, :name, :divorced, :divorced_reason, :sex, :children, :web_url, :relation
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              "The input argument (attributes) must be a hash in `Kuapir::PersonResponseSpouses` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Kuapir::PersonResponseSpouses`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.divorced = attributes[:divorced] if attributes.key?(:divorced)

      self.divorced_reason = attributes[:divorced_reason] if attributes.key?(:divorced_reason)
      ...
      self.relation = attributes[:relation] if attributes.key?(:relation)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        divorced_reason == other.divorced_reason &&
        sex == other.sex &&
    ...
    def hash
      [person_id, name, divorced, divorced_reason, sex, children, web_url, relation].hash
    end
