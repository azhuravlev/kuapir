...
module Kuapir
  class FilmSearchByFiltersResponseItems
    attr_accessor :kinopoisk_id, :imdb_id, :name_ru, :name_en, :name_original, :countries, :genres, :rating_kinopoisk,
                  :rating_imdb, :year, :type, :poster_url, :poster_url_preview
    ...
    def type=(type)
      validator = EnumAttributeValidator.new("String", %w[FILM TV_SHOW VIDEO MINI_SERIES TV_SERIES UNKNOWN])
