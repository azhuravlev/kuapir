...
module Kuapir
  class DigitalReleaseItem
    ...
    def initialize(attributes = {})
      ...
      self.expectations_rating_vote_count = attributes[:expectations_rating_vote_count] if attributes.key?(:expectations_rating_vote_count)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "rating_vote_count", rating_vote_count cannot be nil.') if @rating_vote_count.nil?

      invalid_properties.push('invalid value for "expectations_rating", expectations_rating cannot be nil.') if @expectations_rating.nil?

      invalid_properties.push('invalid value for "expectations_rating_vote_count", expectations_rating_vote_count cannot be nil.') if @expectations_rating_vote_count.nil?
