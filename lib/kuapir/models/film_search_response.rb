...
module Kuapir
  class FilmSearchResponse
    ...
    def initialize(attributes = {})
      ...
      self.search_films_count_result = attributes[:search_films_count_result] if attributes.key?(:search_films_count_result)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "search_films_count_result", search_films_count_result cannot be nil.') if @search_films_count_result.nil?
