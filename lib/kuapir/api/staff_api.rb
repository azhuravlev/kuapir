...
module Kuapir
  class StaffApi
    ...
    def api_v1_staff_get_with_http_info(film_id, opts = {})
      ...
      raise ArgumentError, "Missing the required parameter 'film_id' when calling StaffApi.api_v1_staff_get" if @api_client.config.client_side_validation && film_id.nil?
    ...
    def api_v1_staff_id_get_with_http_info(id, opts = {})
      ...
      raise ArgumentError, "Missing the required parameter 'id' when calling StaffApi.api_v1_staff_id_get" if @api_client.config.client_side_validation && id.nil?
