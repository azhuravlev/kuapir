...
module Kuapir
  class PersonsApi
    ...
    def api_v1_persons_get_with_http_info(name, opts = {})
      ...
      raise ArgumentError, "Missing the required parameter 'name' when calling PersonsApi.api_v1_persons_get" if @api_client.config.client_side_validation && name.nil?
