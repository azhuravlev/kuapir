...
module Kuapir
  class ReviewsApi
    ...
    def api_v1_reviews_details_get_with_http_info(review_id, opts = {})
      @api_client.config.logger.debug "Calling API: ReviewsApi.api_v1_reviews_details_get ..." if @api_client.config.debugging
    ...
    def api_v1_reviews_get_with_http_info(film_id, opts = {})
      ...
      raise ArgumentError, "Missing the required parameter 'film_id' when calling ReviewsApi.api_v1_reviews_get" if @api_client.config.client_side_validation && film_id.nil?
