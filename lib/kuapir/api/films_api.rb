...
module Kuapir
  class FilmsApi
    ...
    def api_v21_films_id_sequels_and_prequels_get_with_http_info(id, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v21_films_id_sequels_and_prequels_get ..." if @api_client.config.debugging
    ...
    def api_v21_films_releases_get_with_http_info(year, month, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v21_films_releases_get ..." if @api_client.config.debugging
      # verify the required parameter 'year' is set
      raise ArgumentError, "Missing the required parameter 'year' when calling FilmsApi.api_v21_films_releases_get" if @api_client.config.client_side_validation && year.nil?
      # verify the required parameter 'month' is set
      raise ArgumentError, "Missing the required parameter 'month' when calling FilmsApi.api_v21_films_releases_get" if @api_client.config.client_side_validation && month.nil?

      # verify enum value
      allowable_values = %w[JANUARY FEBRUARY MARCH APRIL MAY JUNE JULY AUGUST SEPTEMBER
                            OCTOBER NOVEMBER DECEMBER]
      raise ArgumentError, "invalid value for \"month\", must be one of #{allowable_values}" if @api_client.config.client_side_validation && !allowable_values.include?(month)
    ...
    def api_v21_films_search_by_keyword_get_with_http_info(keyword, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v21_films_search_by_keyword_get ..." if @api_client.config.debugging
    ...
    def api_v22_films_filters_get_with_http_info(opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_filters_get ..." if @api_client.config.debugging
      # resource path
    ...
    def api_v22_films_get_with_http_info(opts = {})
      ...
      raise ArgumentError, "invalid value for \"order\", must be one of #{allowable_values}" if @api_client.config.client_side_validation && opts[:order] && !allowable_values.include?(opts[:order])

      allowable_values = %w[FILM TV_SHOW VIDEO MINI_SERIES TV_SERIES ALL]
    ...
    def api_v22_films_id_box_office_get_with_http_info(id, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_id_box_office_get ..." if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling FilmsApi.api_v22_films_id_box_office_get" if @api_client.config.client_side_validation && id.nil?
    ...
    def api_v22_films_id_distributions_get_with_http_info(id, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_id_distributions_get ..." if @api_client.config.debugging
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        raise ArgumentError,
    ...
    def api_v22_films_id_facts_get_with_http_info(id, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_id_facts_get ..." if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling FilmsApi.api_v22_films_id_facts_get" if @api_client.config.client_side_validation && id.nil?
    ...
    def api_v22_films_id_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling FilmsApi.api_v22_films_id_get" if @api_client.config.client_side_validation && id.nil?
    ...
    def api_v22_films_id_images_get_with_http_info(id, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_id_images_get ..." if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling FilmsApi.api_v22_films_id_images_get" if @api_client.config.client_side_validation && id.nil?
      ...
      allowable_values = %w[STILL SHOOTING POSTER FAN_ART PROMO CONCEPT WALLPAPER COVER
                            SCREENSHOT]
      raise ArgumentError, "invalid value for \"type\", must be one of #{allowable_values}" if @api_client.config.client_side_validation && opts[:type] && !allowable_values.include?(opts[:type])
    ...
    def api_v22_films_id_seasons_get_with_http_info(id, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_id_seasons_get ..." if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling FilmsApi.api_v22_films_id_seasons_get" if @api_client.config.client_side_validation && id.nil?
    ...
    def api_v22_films_id_similars_get_with_http_info(id, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_id_similars_get ..." if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling FilmsApi.api_v22_films_id_similars_get" if @api_client.config.client_side_validation && id.nil?
    ...
    def api_v22_films_id_videos_get_with_http_info(id, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_id_videos_get ..." if @api_client.config.debugging
      # verify the required parameter 'id' is set
      raise ArgumentError, "Missing the required parameter 'id' when calling FilmsApi.api_v22_films_id_videos_get" if @api_client.config.client_side_validation && id.nil?
    ...
    def api_v22_films_premieres_get_with_http_info(year, month, opts = {})
      @api_client.config.logger.debug "Calling API: FilmsApi.api_v22_films_premieres_get ..." if @api_client.config.debugging
      # verify the required parameter 'year' is set
      raise ArgumentError, "Missing the required parameter 'year' when calling FilmsApi.api_v22_films_premieres_get" if @api_client.config.client_side_validation && year.nil?
      # verify the required parameter 'month' is set
      raise ArgumentError, "Missing the required parameter 'month' when calling FilmsApi.api_v22_films_premieres_get" if @api_client.config.client_side_validation && month.nil?
